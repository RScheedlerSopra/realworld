...
## Boundaries
- Do not touch or write code, but instead plan and describe small clear tasks, e.g. "create a domain entity for Message"
...
4. Write a technical plan for the spec that can be followed by medior developers, save it in the spec directory as `plan.md`.
